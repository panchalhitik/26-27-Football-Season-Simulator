...
export const FORMATIONS: Formation[] = [
  ...
  },
  {
    shape: '5-3-2',
    label: '5-3-2',
    description: 'Back five, compact — hit them on the break.',
    slots: [
      gk,
      { position: 'LB', x: 10, y: 68 },
      { position: 'CB', x: 30, y: 78 },
      { position: 'CB', x: 50, y: 80 },
      { position: 'CB', x: 70, y: 78 },
      { position: 'RB', x: 90, y: 68 },
      { position: 'CM',  x: 30, y: 48 },
      { position: 'CDM', x: 50, y: 54 },
      { position: 'CM',  x: 70, y: 48 },
      { position: 'ST',  x: 38, y: 18 },
      { position: 'ST',  x: 62, y: 18 },
    ],
  },
  {
    shape: '5-4-1',
    label: '5-4-1 Bus',
    description: 'The bus is parked. One striker lives off scraps.',
    slots: [
      gk,
      { position: 'LB', x: 10, y: 70 },
      { position: 'CB', x: 30, y: 79 },
      { position: 'CB', x: 50, y: 81 },
      { position: 'CB', x: 70, y: 79 },
  ...
  },
  {
    shape: '4-5-1',
    label: '4-5-1',
    description: 'Midfield swarm, lone frontman.',
    slots: [
      gk,
      ...back4(),
